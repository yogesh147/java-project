            ...
            <%
                    ...
                    //   out.println(request.getParameter("cities"));
                       ...
                       //     out.println(request.getParameter("city"));
                            ...
                            {
                            query = "select * from postadd where category='"+cate+"' ";
                            }
                            else
                            {
                               query = "select * from postadd where category='"+cate+"' And city='"+request.getParameter("city")+"' ";
                ...
                <div class="category-list">
                    <div id="parentVerticalTab">
                        <ul class="resp-tabs-list " style="padding-top:0px;">
                            ...
                            <li><a class="tabs"  href="categories.jsp?cat=Mobiles&city=<%out.print(cityy); %>">Mobiles</a></li>
                            <hr>
                            <li><a class="tabs" href="categories.jsp?cat=Electronics and Appliance&city=<%out.print(cityy); %>">Electronics & Appliances</a></li>
