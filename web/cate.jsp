                ...
                <div class="category-list">
                    <div id="parentVerticalTab">
                        <ul class="resp-tabs-list " style="padding-top:0px;">
                            ...
                            <li><a class="tabs" href="categories.jsp?cat=Cars&city=<%out.print(cityy); %>">Cars</a></li><hr> 
                            <li><a class="tabs" href="categories.jsp?cat=Bikes&city=<%out.print(cityy); %>">Bikes</a></li><hr> 
                            <li><a class="tabs" href="categories.jsp?cat=Furniture&city=<%out.print(cityy); %>">Furniture</a></li><hr>
                            <li><a class="tabs" href="categories.jsp?cat=Pets&city=<%out.print(cityy); %>">Pets</a></li><hr> 
                            <li><a class="tabs" href="categories.jsp?cat=Books, Sports and Hobbies&city=<%out.print(cityy); %>">Books, Sports and Hobbies</a></li><hr>
                            <li><a class="tabs" href="categories.jsp?cat=Fashion&city=<%out.print(cityy); %>">Fashion</a></li><hr>
                            <li><a class="tabs" href="categories.jsp?cat=Kids&city=<%out.print(cityy); %>">Kids</a></li><hr> 
                            <li><a  class="tabs" href="categories.jsp?cat=Services&city=<%out.print(cityy); %>">Services</a></li><hr> 
                            <li><a class="tabs" href="categories.jsp?cat=Jobs&city=<%out.print(cityy); %>">Jobs</a></li><hr> 
                            <li><a class="tabs" href="categories.jsp?cat=Real Estate&city=<%out.print(cityy); %>">Real Estate</a></li><hr>
