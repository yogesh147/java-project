    ...
    <body>
        <div class="header">
            <div class="container">
                ...
                <div class="header-right">
                    <a class="account" href="categoriest.jsp">Categories</a>
                </div>
            </div>
        </div>
        <div class="header-right">
        ...
        <form action="categoriest.jsp" method="post">
            <div class="total-ads main-grid-border">
                <div class="container">
                    <div class="select-box" style="    padding: 30px 30px 30px 122px;">
                     ...
                     <select name="sort">
                              ...
                              <input type="submit"  class="btn btn-primary" name="city" style=" position: relative;
    left: 160px;padding-left: 1px;    bottom: 10px; width: 115px;height: 36px;border-radius: 10px;"/>
        ...
        <% 
            ...
            //   JOptionPane.showMessageDialog(null, sort1 + " " + sort2+ " " +sort);
            try {
             //   out.print(sort);
                ...
                if (request.getParameter("city").equals("null")) {
                    ...
                    query = "select * from postadd where category='" + cate + "' ORDER BY price asc";
                } else if (cate.equals("")) {
              //     JOptionPane.showMessageDialog(null, sort);
                    query = "select * from postadd where city='" + request.getParameter("city") + "' ORDER BY price "+sort+" ";
                    ...
                    query = "select * from postadd where category='" + cate + "' And city='" + request.getParameter("city") + "' ORDER BY price asc ";
                } else {
                ...
                <div class="category-list">
                    <div id="parentVerticalTab">
                        <ul class="resp-tabs-list " style="padding-top:0px;">
                            <li><a class="tabs"  href="categoriest.jsp?cat=Mobiles&city=<%out.print(cityy); %>">Mobiles</a></li><hr>
                            <li><a class="tabs" href="categoriest.jsp?cat=Electronics and Appliance&city=<%out.print(cityy); %>">Electronics & Appliances</a></li><hr>
                            <li><a class="tabs" href="categoriest.jsp?cat=Cars&city=<%out.print(cityy); %>">Cars</a></li><hr> 
                            <li><a class="tabs" href="categoriest.jsp?cat=Bikes&city=<%out.print(cityy); %>">Bikes</a></li><hr> 
                            <li><a class="tabs" href="categoriest.jsp?cat=Furniture&city=<%out.print(cityy); %>">Furniture</a></li><hr>
                            <li><a class="tabs" href="categoriest.jsp?cat=Pets&city=<%out.print(cityy); %>">Pets</a></li><hr> 
                            <li><a class="tabs" href="categoriest.jsp?cat=Books, Sports and Hobbies&city=<%out.print(cityy); %>">Books, Sports and Hobbies</a></li><hr>
                            <li><a class="tabs" href="categoriest.jsp?cat=Fashion&city=<%out.print(cityy); %>">Fashion</a></li><hr>
                            <li><a class="tabs" href="categoriest.jsp?cat=Kids&city=<%out.print(cityy); %>">Kids</a></li><hr> 
                            <li><a  class="tabs" href="categoriest.jsp?cat=Services&city=<%out.print(cityy); %>">Services</a></li><hr> 
                            <li><a class="tabs" href="categoriest.jsp?cat=Jobs&city=<%out.print(cityy); %>">Jobs</a></li><hr> 
                            <li><a class="tabs" href="categoriest.jsp?cat=Real Estate&city=<%out.print(cityy); %>">Real Estate</a></li><hr>
                            <li><a class="tabs" href="all-classifieds.html">All Ads</a></li>
                        </ul>
                            ...
                            <div>
                                <div id="container">
                                    ...
                                    <ul class="list">
                                        ...
                                        <a href="desct.jsp?id=<% out.print(id); %>">
                                            <li>
                                                ...
                                                <section class="list-left">
                                                    ...
                                                    <div class="adprice" style="display: inline-flex;">
                                                        ...
                                                        <div style="margin-left: 5px;"><% out.print(price); %></div>
                                                    </div>
